...
@implementation ZYDRefreshNetworkErrorView
...
- (UIImageView *)tipImageView {
    if (!_tipImageView) {
        _tipImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"tb_noNetwork"]];
    }
